...
<head>
	...
	<script src="https://kit.fontawesome.com/771971e265.js" crossorigin="anonymous"></script>
	<!-- <script src="assets/js/bootstrap.js"></script> -->
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script>
	<script src="assets/js/bootbox.min.js"></script>
	<script src="assets/js/vamosjogar.js"></script>
	...
	<div class="top_bar"> 
		...
		<div class="search">
			...
			<form action="search.php" method="GET" name="search_form">
				<input type="text" onkeyup="getLiveSearchUsers(this.value, '<?php echo $userLoggedIn; ?>')" name="q" placeholder="Pesquisar..." autocomplete="off" id="search_text_input">
