...
class Message {
	...
	public function getLatestMessage($userLoggedIn, $user2) {
		...
		$row = mysqli_fetch_array($query);
		$sent_by = ($row['user_to'] == $userLoggedIn) ? "Eles disseram: " : "Você disse: ";
	...
	public function getConvosDropdown($data, $limit) {
		...
		if($count > $limit)
			...
			$return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center;'>Não há mais mensagens para carregar!</p>";
